...
I need to answer this question to make the content EEAT compliant.
...
On all of the 3 pages I've set:
...
| Nav – sign up                                               | Click on register in the navigation.                                                                                                                | It redirects to the sign-up page “/accounts/signup/”.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | PASS             |
| Nav – sign up                                               | Click on register in the navigation.                                                                                                                | The only links appearing in the nav are ‘register and sign up’                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | PASS             |
...
| Sign up – step 1 - feedback                                 | Signup to the app                                                                                                                                   | A message saying to approve your email appears on screen                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | PASS             |
...
| Sign up – step 3 - feedback - seeker/advisor                | Complete the signup step 3                                                                                                                          | A message saying the signup is completed appears on screen                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | PASS             |
| Sign up – step 3 - feedback = seeker/advisor                | Complete the signup step 3                                                                                                                          | A message saying the signup is completed appears on screen                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | PASS             |
...
| Sign in - feedback                                          | Complete the sign in                                                                                                                                | A message saying you have signed in appears on screen                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | PASS             |
| Seeker matching                                             | Complete the 3 step sign in                                                                                                                         | You’ll be matched with an advisor that is active, approved, specialised in the seeker request, in the same city as the seeker                                                                                                                                                                                                                                                                                                                                                                                                                           | PASS             |
| Seeker Matching                                             | Complete the 3 step sign in                                                                                                                         | If, the conditions at the previous test aren’t matched: match an advisor that is approved, active and specialise in the seeker’s need.                                                                                                                                                                                                                                                                                                                                                                                                                  | PASS             |
...
| Seeker profile                                              | Update the seekers/profile details                                                                                                                  | The page refreshed and the details are updated.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | PASS             |
...
| Seeker checkout                                             | Complete the checkout form and submit                                                                                                               | If the payment went right: Order model object is created The consultation status turns to ‘confirmed’ The order paid boolean field turns ‘True’ The seeker receives an email with the order and meeting details The advisor receives an email saying the consultation has been confirmed The user is redirected to the checkout success page Navigating to seekers/advisor/: the ‘confirm consultation button’ turned to ‘start meeting’  If the payment doesn’t go through: The user receives an email saying the payment failed and asks to try again | PASS             |
...
| Advisor - client - profile - schedule consultation          | On the page advisors/clients/*, click on schedule consultation and complete form                                                                    | The consultation appears on chat The client receives an email with the consultation details and a link to pay. The consultation appears on the ‘appointments’ page Submitting an uncompleted form will raise an error The ‘schedule consultation’ button is disabled until consultation is paid                                                                                                                                                                                                                                                         | PASS             |
...
- combine multiple queysets into 1 (combine messages and consultations in chat page)[stackoverflow](https://stackoverflow.com/questions/431628/how-to-combine-multiple-querysets-in-django)

"""
Django settings for advisor_finder project.
...
ROOT_URLCONF = 'advisor_finder.urls'
...
ACCOUNT_SIGNUP_REDIRECT_URL = '/advisor-or-seeker/'
...
# Apply Bootstrap css classes to message alerts
MESSAGE_TAGS = {
